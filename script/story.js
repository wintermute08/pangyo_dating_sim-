...
window.STORY = {
  ...
  scenes: [
    ...
    },
    {
      ...
      number: '04',
      title: '숨을 고르는 동안',
      chapter: 'FIFTH PERIOD',
      bg: 'bg06_gym_afternoon',
      bgm: 'day',
      lines: [
        { t: 'narr', text: '5교시는 체육이었다. 4월인데도 체육관 바닥은 아직 서늘했다.' },
        { t: 'sfx', id: 'footstep_01' },
        { t: 'narr', text: '공이 튀는 소리가 천장에 한 번 부딪혔다가, 한 박자 늦게 돌아왔다.' },
        { t: 'chara', show: true, look: 'hoodie_calm' },
        ...
        { t: 'say', who: 'unknown', look: 'hoodie_calm', text: '지난주 체육시간에도 여기 왔었거든. 혹시나 해서.' },
        {
          ...
          options: [
            ...
            },
            {
              ...
              affection: 0,
              react: [
                { t: 'say', who: 'unknown', look: 'hoodie_calm', text: '그치. 3년 다녔는데 이렇게 자세히 본 건 처음이야.' }
              ]
            }
          ]
        },
